module NPLAB
  ...
  class CDirectionsGeneratorInSpace < CDirectionsGenerator
    ...
    def self.get_directions_in_space(nDirections)
      case nDirections
      when 4
        directions = ShootScriptUtil.get_tetrahedron_centers()
      when 6
        directions = ShootScriptUtil.get_cube_centers()
      when 8
        directions = ShootScriptUtil.get_cube_vetices()
      when 12
        directions = ShootScriptUtil.get_dodecahedron_centers()
      when 20
        directions = ShootScriptUtil.get_dodecahedron_vetices()
      else
